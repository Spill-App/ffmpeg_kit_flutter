...
abstract class AbstractSession extends Session {
  ...
  static Future<FFprobeSession> createFFprobeSession(List<String> argumentsArray,
      [LogRedirectionStrategy? logRedirectionStrategy]) async {
    try {
      await FFmpegKitConfig.init();
  ...
  static Future<MediaInformationSession> createMediaInformationSession(List<String> argumentsArray) async {
    try {
      ...
      final Map<dynamic, dynamic>? nativeSession =
          await _platform.abstractSessionCreateMediaInformationSession(argumentsArray);
